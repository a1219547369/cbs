...
<li><a href="" style="font-weight:bold;font-family:Microsoft YaHei">6</a></li>
  ...
  <div class="container" align="center" style="background-color:#f0f0f0;border-radius:40px;opacity:0.6">
	...
	<br>
	<br>
    <form method="post" action="AddParServlet">
	<h1 class="form-signin-heading">添加参与者</h1>
	<input type="hidden" name="projectname" value="<% out.print(pname); %>" />
    <table border="0">
    <tr style="height:80">
    <td align="center"><label>用户名称：</label></td>
    <td align="center" colspan="4">
    <input name="participant" style="width:100%" rows="1" class="form-control"></input>
    </td>
    </tr>
